...
import com.chaoji.other.huantansheng.easyphotos.models.album.entity.AlbumItem;
...
public class AlbumItemsAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            default:
                return new AlbumItemsViewHolder(mInflater.inflate(R.layout._easy_photos_item_dialog_album_items, parent, false));
        }
    }
