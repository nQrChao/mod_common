...
import com.chaoji.other.huantansheng.easyphotos.ui.adapter.PuzzleSelectorAdapter;
import com.chaoji.other.huantansheng.easyphotos.ui.adapter.PuzzleSelectorPreviewAdapter;
...
public class PuzzleSelectorActivity extends AppCompatActivity implements View.OnClickListener, AlbumItemsAdapter.OnClickListener, PuzzleSelectorAdapter.OnClickListener, PuzzleSelectorPreviewAdapter.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout._easy_photos_activity_puzzle_selector);
