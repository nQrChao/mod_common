...
import com.chaoji.other.huantansheng.easyphotos.models.puzzle.SquarePuzzleView;
import com.chaoji.other.huantansheng.easyphotos.models.puzzle.template.slant.NumberSlantLayout;
import com.chaoji.other.huantansheng.easyphotos.models.puzzle.template.straight.NumberStraightLayout;
...
public class PuzzleAdapter extends RecyclerView.Adapter<PuzzleAdapter.PuzzleViewHolder> {
    ...
    public PuzzleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView =
                LayoutInflater.from(parent.getContext()).inflate(R.layout._easy_photos_item_puzzle, parent, false);
