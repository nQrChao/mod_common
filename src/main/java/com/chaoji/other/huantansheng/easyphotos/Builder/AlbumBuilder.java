package com.chaoji.other.huantansheng.easyphotos.Builder;
...
import com.chaoji.other.huantansheng.easyphotos.callback.SelectCallback;
...
import com.chaoji.other.huantansheng.easyphotos.ui.EasyPhotosActivity;
...
public class AlbumBuilder {
    ...
    public void start(int requestCode,ActivityResultLauncher<Intent> activityResultLauncher) {
        setSettingParams();
        launchEasyPhotosActivity(requestCode,activityResultLauncher);
    }
     ...
     * 正式启动
     */
    private void launchEasyPhotosActivity(int requestCode, ActivityResultLauncher<Intent> activityResultLauncher) {
        if (null != activityResultLauncher) {
            EasyPhotosActivity.start(mActivity.get(), requestCode, activityResultLauncher);
        }
        if (null != mActivity && null != mActivity.get()) {
