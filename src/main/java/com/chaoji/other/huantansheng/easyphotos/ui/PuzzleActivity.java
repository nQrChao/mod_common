package com.chaoji.other.huantansheng.easyphotos.ui;
...
import com.chaoji.other.huantansheng.easyphotos.EasyPhotos;
import com.chaoji.other.huantansheng.easyphotos.constant.Code;
import com.chaoji.other.huantansheng.easyphotos.constant.Key;
import com.chaoji.other.huantansheng.easyphotos.engine.ImageEngine;
import com.chaoji.other.huantansheng.easyphotos.models.album.entity.Photo;
import com.chaoji.other.huantansheng.easyphotos.models.puzzle.Area;
import com.chaoji.other.huantansheng.easyphotos.models.puzzle.DegreeSeekBar;
import com.chaoji.other.huantansheng.easyphotos.models.puzzle.PuzzleLayout;
import com.chaoji.other.huantansheng.easyphotos.models.puzzle.PuzzlePiece;
import com.chaoji.other.huantansheng.easyphotos.models.puzzle.PuzzleUtils;
import com.chaoji.other.huantansheng.easyphotos.models.puzzle.PuzzleView;
import com.chaoji.other.huantansheng.easyphotos.models.sticker.StickerModel;
import com.chaoji.other.huantansheng.easyphotos.setting.Setting;
import com.chaoji.other.huantansheng.easyphotos.ui.adapter.PuzzleAdapter;
import com.chaoji.other.huantansheng.easyphotos.ui.adapter.TextStickerAdapter;
import com.chaoji.other.huantansheng.easyphotos.utils.bitmap.SaveBitmapCallBack;
import com.chaoji.other.huantansheng.easyphotos.utils.media.DurationUtils;
import com.chaoji.other.huantansheng.easyphotos.utils.permission.PermissionUtil;
import com.chaoji.other.huantansheng.easyphotos.utils.settings.SettingsUtils;
import com.chaoji.other.huantansheng.easyphotos.utils.uri.UriUtils;
...
public class PuzzleActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout._easy_photos_activity_puzzle);
        ...
        ImmersionBar.with(this) // 默认状态栏字体颜色为黑色
                .statusBarColor(R.color.easy_photos_bar_primary)
                .navigationBarColor(R.color.easy_photos_bar_primary) // 状态栏字体和导航栏内容自动变色，必须指定状态栏颜色和导航栏颜色才可以自动变色
    ...
    private void processBottomLayout() {
        if (View.VISIBLE == mBottomLayout.getVisibility()) {
            ...
            fab.setImageResource(R.drawable.easy_photos_ic_arrow_up);
        } else {
            mBottomLayout.setVisibility(View.VISIBLE);
            fab.setImageResource(R.drawable.easy_photos_ic_arrow_down);
        }
    }
