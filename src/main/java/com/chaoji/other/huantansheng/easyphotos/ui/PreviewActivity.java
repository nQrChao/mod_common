...
import com.chaoji.other.huantansheng.easyphotos.ui.adapter.PreviewPhotosAdapter;
...
public class PreviewActivity extends AppCompatActivity implements PreviewPhotosAdapter.OnClickListener, View.OnClickListener, PreviewFragment.OnPreviewFragmentClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout._easy_photos_activity_preview);
    ...
    public void onPhotoClick() {
        if(photos.get(lastPosition).type.contains(Type.VIDEO)){
            Toaster.show("VIDEO");
        }
        toggle();
    }
...
//        }
    ...
    private void toggleSelector() {
        if (photos.get(lastPosition).selected) {
            ivSelector.setImageResource(R.drawable.easy_photos_ic_selector_true);
            if (!Result.isEmpty()) {
            ...
            ivSelector.setImageResource(R.drawable.easy_photos_ic_selector);
        }
