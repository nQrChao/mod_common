...
public class ShapeDrawable extends Drawable {
    ...
    public ShapeDrawable setShadowSize(int size) {
        mShapeState.shadowSizeAll = size;
        mPathDirty = true;
        mRectDirty = true;
        invalidateSelf();
        return this;
    ...
    public ShapeDrawable setShadowSize(int left,int right,int top,int bottom,int All) {
        mShapeState.shadowSizeLeft = left;
        mShapeState.shadowSizeRight = right;
        mShapeState.shadowSizeTop = top;
        mShapeState.shadowSizeBottom = bottom;
        mShapeState.shadowSizeAll = All;
        mPathDirty = true;
        mRectDirty = true;
        invalidateSelf();
        return this;
    ...
    public void intoBackground(View view) {
        if (mShapeState.strokeDashGap > 0 || mShapeState.shadowSizeAll > 0) {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        final boolean haveShadow = mShapeState.shadowSizeAll > 0;
        ...
        */
        ...
        if (haveShadow) {
            ...
            if (haveStroke) {
                ...
                mShadowPaint.setStrokeWidth(mShapeState.shadowSizeAll / 4f);
            }
            ...
            if (ShapeDrawableUtils.setColorAlphaComponent(mShapeState.shadowColor, 255) == mShapeState.shadowColor) {
             ...
             if (Build.VERSION.SDK_INT >= 28) {
                 shadowRadius = mShapeState.shadowSizeAll / 2f;
             } else {
                 shadowRadius = mShapeState.shadowSizeAll / 3f;
             }
    ...
    private boolean ensureValidRect() {
        ...
        float let = bounds.left + inset + mShapeState.shadowSizeLeft;
        float top = bounds.top + inset + mShapeState.shadowSizeTop;
        float right = bounds.right - inset - mShapeState.shadowSizeRight;
        float bottom = bounds.bottom - inset - mShapeState.shadowSizeBottom;
