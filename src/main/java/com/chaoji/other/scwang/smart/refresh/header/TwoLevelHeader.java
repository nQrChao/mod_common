...
import com.chaoji.other.scwang.smartrefresh.layout.header.ClassicsHeader;
import com.chaoji.other.scwang.smart.refresh.header.listener.OnTwoLevelListener;
...
public class TwoLevelHeader extends SimpleComponent implements RefreshHeader, NestedScrollingParent2 {
    ...
    public TwoLevelHeader(Context context, @Nullable AttributeSet attrs) {
        ...
        mEnableRefresh = ta.getBoolean(R.styleable.TwoLevelHeader_enableRefresh, mEnableRefresh);
