package com.chaoji.other.scwang.smart.refresh.layout;
...
import static com.chaoji.other.scwang.smart.refresh.layout.util.SmartUtil.dp2px;
import static com.chaoji.other.scwang.smart.refresh.layout.util.SmartUtil.fling;
import static com.chaoji.other.scwang.smart.refresh.layout.util.SmartUtil.isContentView;
...
import com.chaoji.other.scwang.smart.refresh.layout.api.RefreshComponent;
import com.chaoji.other.scwang.smart.refresh.layout.api.RefreshContent;
...
import com.chaoji.other.scwang.smart.refresh.layout.api.RefreshKernel;
import com.chaoji.other.scwang.smart.refresh.layout.api.RefreshLayout;
import com.chaoji.other.scwang.smart.refresh.layout.constant.DimensionStatus;
import com.chaoji.other.scwang.smart.refresh.layout.constant.RefreshState;
import com.chaoji.other.scwang.smart.refresh.layout.constant.SpinnerStyle;
import com.chaoji.other.scwang.smart.refresh.layout.listener.DefaultRefreshFooterCreator;
import com.chaoji.other.scwang.smart.refresh.layout.listener.DefaultRefreshHeaderCreator;
import com.chaoji.other.scwang.smart.refresh.layout.listener.DefaultRefreshInitializer;
import com.chaoji.other.scwang.smart.refresh.layout.listener.OnLoadMoreListener;
import com.chaoji.other.scwang.smart.refresh.layout.listener.OnMultiListener;
import com.chaoji.other.scwang.smart.refresh.layout.listener.OnRefreshListener;
import com.chaoji.other.scwang.smart.refresh.layout.listener.OnRefreshLoadMoreListener;
import com.chaoji.other.scwang.smart.refresh.layout.listener.OnStateChangedListener;
import com.chaoji.other.scwang.smart.refresh.layout.listener.ScrollBoundaryDecider;
import com.chaoji.other.scwang.smart.refresh.layout.simple.SimpleBoundaryDecider;
import com.chaoji.other.scwang.smart.refresh.layout.util.SmartUtil;
import com.chaoji.other.scwang.smart.refresh.layout.wrapper.RefreshContentWrapper;
import com.chaoji.other.scwang.smart.refresh.layout.wrapper.RefreshFooterWrapper;
import com.chaoji.other.scwang.smart.refresh.layout.wrapper.RefreshHeaderWrapper;
...
//        if(mLastTouchYOnActionDown< ScreenUtils.getAppScreenHeight() *0.9 && mState == RefreshState.TwoLevel){
//            return false;
//        }
...
//            reboundAnimator.setDuration(20000);
    ...
    protected void overSpinner() {
        if (mState == RefreshState.TwoLevel) {
            ...
            if (mCurrentVelocity > -1000 && mSpinner > thisView.getHeight() / 2) {
                /*****************************************解决二楼会全部隐藏，此处保留0.9，方便点击******************************************/
                double height09 = thisView.getHeight() * 0.9;
                double heightDifference = mSpinner - height09;
                //Logs.e("heightDifference:" + heightDifference);
                if (heightDifference < -100 || heightDifference > 100) {
                    ValueAnimator animator = mKernel.animSpinner((int) height09);
                    if (animator != null) {
                        animator.setDuration(mFloorDuration);
                    }
                    //Logs.e("高度差 " + heightDifference + " 不在正负 100 范围内");
                }
                /*****************************************解决二楼会全部隐藏，此处保留0.9，方便点击******************************************/
    ...
    protected void moveSpinnerInfinitely(float spinner) {
         ...
         *
         * 2.XML关闭
         *          <com.chaoji.other.scwang.smart.refresh.layout.SmartRefreshLayout
            ...
            if ((spinner >= 0 || oldSpinner > 0) && mRefreshHeader != null) {
                ...
                if (isEnableRefreshOrLoadMore(mEnableRefresh) || (mState == RefreshState.RefreshFinish && !isDragging)) {
                    if (oldSpinner != mSpinner) {
                        //Logs.e("headerHeight:"+headerHeight+"--maxDragHeight:"+maxDragHeight);
                        if (mRefreshHeader.getSpinnerStyle() == SpinnerStyle.Translate) {
