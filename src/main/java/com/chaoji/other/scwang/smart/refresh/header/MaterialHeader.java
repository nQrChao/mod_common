package com.chaoji.other.scwang.smart.refresh.header;
...
import com.chaoji.other.scwang.smart.refresh.header.material.CircleImageView;
import com.chaoji.other.scwang.smart.refresh.header.material.MaterialProgressDrawable;
...
//        mProgress.setAlpha(255);
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.MaterialHeaderIm);

        mShowBezierWave = ta.getBoolean(R.styleable.MaterialHeaderIm_srlShowBezierWaveIm, mShowBezierWave);
        mScrollableWhenRefreshing = ta.getBoolean(R.styleable.MaterialHeaderIm_srlScrollableWhenRefreshingIm, mScrollableWhenRefreshing);
        mBezierPaint.setColor(ta.getColor(R.styleable.MaterialHeaderIm_srlPrimaryColorIm, 0xff11bbff));
        if (ta.hasValue(R.styleable.MaterialHeaderIm_srlShadowRadiusIm)) {
            int radius = ta.getDimensionPixelOffset(R.styleable.MaterialHeaderIm_srlShadowRadiusIm, 0);
            int color = ta.getColor(R.styleable.MaterialHeaderIm_mhShadowColorIm, 0xff000000);
            mBezierPaint.setShadowLayer(radius, 0, 0, color);
            thisView.setLayerType(LAYER_TYPE_SOFTWARE, null);
        }

        mShowBezierWave = ta.getBoolean(R.styleable.MaterialHeaderIm_mhShowBezierWaveIm, mShowBezierWave);
        mScrollableWhenRefreshing = ta.getBoolean(R.styleable.MaterialHeaderIm_mhScrollableWhenRefreshingIm, mScrollableWhenRefreshing);
        if (ta.hasValue(R.styleable.MaterialHeaderIm_mhPrimaryColorIm)) {
            mBezierPaint.setColor(ta.getColor(R.styleable.MaterialHeaderIm_mhPrimaryColorIm, 0xff11bbff));
        }
        if (ta.hasValue(R.styleable.MaterialHeaderIm_mhShadowRadiusIm)) {
            int radius = ta.getDimensionPixelOffset(R.styleable.MaterialHeaderIm_mhShadowRadiusIm, 0);
            int color = ta.getColor(R.styleable.MaterialHeaderIm_mhShadowColorIm, 0xff000000);
            mBezierPaint.setShadowLayer(radius, 0, 0, color);
            thisView.setLayerType(LAYER_TYPE_SOFTWARE, null);
        }
