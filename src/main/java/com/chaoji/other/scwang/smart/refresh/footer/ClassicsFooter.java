package com.chaoji.other.scwang.smart.refresh.footer;
...
import com.chaoji.other.scwang.smart.drawable.ProgressDrawable;
import com.chaoji.other.scwang.smart.refresh.classics.ArrowDrawable;
import com.chaoji.other.scwang.smart.refresh.classics.ClassicsAbstract;
...
public class ClassicsFooter extends ClassicsAbstract<ClassicsFooter> implements RefreshFooter {
    ...
    public ClassicsFooter(Context context, AttributeSet attrs) {
        ...
        RelativeLayout.LayoutParams lpArrow = (LayoutParams) arrowView.getLayoutParams();
