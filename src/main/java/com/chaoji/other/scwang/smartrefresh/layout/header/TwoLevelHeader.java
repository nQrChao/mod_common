package com.chaoji.other.scwang.smartrefresh.layout.header;
...
import com.chaoji.other.scwang.smartrefresh.layout.api.OnTwoLevelListener;
...
public class TwoLevelHeader extends com.chaoji.other.scwang.smart.refresh.header.TwoLevelHeader implements RefreshHeader {
    ...
    public TwoLevelHeader setOnTwoLevelListener(final OnTwoLevelListener listener) {
        super.setOnTwoLevelListener(new com.chaoji.other.scwang.smart.refresh.header.listener.OnTwoLevelListener() {
            @Override
            public boolean onTwoLevel(@NonNull com.chaoji.other.scwang.smart.refresh.layout.api.RefreshLayout refreshLayout) {
    ...
    @Override
    public TwoLevelHeader setRefreshHeader(com.chaoji.other.scwang.smart.refresh.layout.api.RefreshHeader header) {
        super.setRefreshHeader(header);
        return this;
    }

    @Override
    public TwoLevelHeader setRefreshHeader(com.chaoji.other.scwang.smart.refresh.layout.api.RefreshHeader header, int width, int height) {
