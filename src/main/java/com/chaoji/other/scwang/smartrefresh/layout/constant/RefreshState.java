package com.chaoji.other.scwang.smartrefresh.layout.constant;
...
public enum RefreshState {
    ...
    public static RefreshState from(com.chaoji.other.scwang.smart.refresh.layout.constant.RefreshState newState) {
