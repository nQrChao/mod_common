package com.chaoji.other.scwang.smartrefresh.layout;
...
import com.chaoji.other.scwang.smartrefresh.layout.api.DefaultRefreshFooterCreator;
import com.chaoji.other.scwang.smartrefresh.layout.api.DefaultRefreshHeaderCreator;
import com.chaoji.other.scwang.smartrefresh.layout.api.DefaultRefreshInitializer;
...
import com.chaoji.other.scwang.smartrefresh.layout.api.ScrollBoundaryDecider;
import com.chaoji.other.scwang.smartrefresh.layout.footer.BallPulseFooter;
import com.chaoji.other.scwang.smartrefresh.layout.header.BezierRadarHeader;
import com.chaoji.other.scwang.smartrefresh.layout.impl.ScrollBoundaryDeciderAdapter;
import com.chaoji.other.scwang.smartrefresh.layout.listener.OnLoadMoreListener;
import com.chaoji.other.scwang.smartrefresh.layout.listener.OnRefreshListener;
import com.chaoji.other.scwang.smartrefresh.layout.listener.OnRefreshLoadMoreListener;
import com.chaoji.other.scwang.smartrefresh.layout.listener.SimpleMultiPurposeListener;
import com.chaoji.other.scwang.smartrefresh.layout.listener.OnMultiPurposeListener;
...
public class SmartRefreshLayout extends com.chaoji.other.scwang.smart.refresh.layout.SmartRefreshLayout implements RefreshLayout {
...
//    }
    ...
    public RefreshLayout setOnRefreshListener(final OnRefreshListener listener) {
        super.setOnRefreshListener(new com.chaoji.other.scwang.smart.refresh.layout.listener.OnRefreshListener() {
            @Override
            public void onRefresh(@NonNull com.chaoji.other.scwang.smart.refresh.layout.api.RefreshLayout refreshLayout) {
    ...
    public RefreshLayout setOnLoadMoreListener(final OnLoadMoreListener listener) {
        super.setOnLoadMoreListener(new com.chaoji.other.scwang.smart.refresh.layout.listener.OnLoadMoreListener() {
            @Override
            public void onLoadMore(@NonNull com.chaoji.other.scwang.smart.refresh.layout.api.RefreshLayout refreshLayout) {
    ...
    public RefreshLayout setOnRefreshLoadMoreListener(final OnRefreshLoadMoreListener listener) {
        super.setOnRefreshLoadMoreListener(new com.chaoji.other.scwang.smart.refresh.layout.listener.OnRefreshLoadMoreListener() {
            @Override
            public void onLoadMore(@NonNull com.chaoji.other.scwang.smart.refresh.layout.api.RefreshLayout refreshLayout) {
                listener.onLoadMore(SmartRefreshLayout.this);
            }
    ...
    public static void setDefaultRefreshHeaderCreator(@NonNull final DefaultRefreshHeaderCreator creator) {
        com.chaoji.other.scwang.smart.refresh.layout.SmartRefreshLayout.setDefaultRefreshHeaderCreator(new com.chaoji.other.scwang.smart.refresh.layout.listener.DefaultRefreshHeaderCreator() {
            @NonNull
            @Override
            public com.chaoji.other.scwang.smart.refresh.layout.api.RefreshHeader createRefreshHeader(@NonNull Context context, @NonNull com.chaoji.other.scwang.smart.refresh.layout.api.RefreshLayout layout) {
    ...
    public static void setDefaultRefreshFooterCreator(@NonNull final DefaultRefreshFooterCreator creator) {
        com.chaoji.other.scwang.smart.refresh.layout.SmartRefreshLayout.setDefaultRefreshFooterCreator(new com.chaoji.other.scwang.smart.refresh.layout.listener.DefaultRefreshFooterCreator() {
            @NonNull
            @Override
            public com.chaoji.other.scwang.smart.refresh.layout.api.RefreshFooter createRefreshFooter(@NonNull Context context, @NonNull com.chaoji.other.scwang.smart.refresh.layout.api.RefreshLayout layout) {
                if (layout instanceof RefreshLayout) {
    ...
    public static void setDefaultRefreshInitializer(@NonNull final DefaultRefreshInitializer initializer) {
        com.chaoji.other.scwang.smart.refresh.layout.SmartRefreshLayout.setDefaultRefreshInitializer(new com.chaoji.other.scwang.smart.refresh.layout.listener.DefaultRefreshInitializer() {
            @Override
            public void initialize(@NonNull Context context, @NonNull com.chaoji.other.scwang.smart.refresh.layout.api.RefreshLayout layout) {
                if (layout instanceof RefreshLayout) {
