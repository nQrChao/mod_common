package com.chaoji.other.danikula.videocache;

import android.content.Context;
import android.net.Uri;

import com.chaoji.other.blankj.utilcode.util.Logs;
import com.chaoji.other.danikula.videocache.file.DiskUsage;
import com.chaoji.other.danikula.videocache.file.FileNameGenerator;
import com.chaoji.other.danikula.videocache.file.Md5FileNameGenerator;
import com.chaoji.other.danikula.videocache.file.TotalCountLruDiskUsage;
import com.chaoji.other.danikula.videocache.file.TotalSizeLruDiskUsage;
import com.chaoji.other.danikula.videocache.headers.EmptyHeadersInjector;
import com.chaoji.other.danikula.videocache.headers.HeaderInjector;
import com.chaoji.other.danikula.videocache.sourcestorage.SourceInfoStorage;
import com.chaoji.other.danikula.videocache.sourcestorage.SourceInfoStorageFactory;
...
import static com.chaoji.other.danikula.videocache.Preconditions.checkAllNotNull;
import static com.chaoji.other.danikula.videocache.Preconditions.checkNotNull;
...
public class HttpProxyCacheServer {
    ...
    private HttpProxyCacheServer(Config config) {
        ...
        try {
            ...
            Logs.i("Proxy cache server started. Is it alive? " + isAlive());
    ...
    public void registerCacheListener(CacheListener cacheListener, String url) {
        ...
        synchronized (clientsLock) {
            try {
                ...
                Logs.w("Error registering cache listener", e);
            }
        }
    }
    ...
    private void touchFileSafely(File cacheFile) {
        try {
            ...
            Logs.e("Error touching file " + cacheFile, e);
        }
    }
    ...
    private void waitForRequest() {
        try {
            while (!Thread.currentThread().isInterrupted()) {
                ...
                Logs.d("Accept new socket " + socket);
    ...
    private void processSocket(Socket socket) {
        try {
            ...
            Logs.d("Request to cache proxy:" + request);
            ...
            Logs.d("Closing socket… Socket is closed by client.");
        } catch (ProxyCacheException | IOException e) {
            onError(new ProxyCacheException("Error processing request", e));
        } finally {
            releaseSocket(socket);
            Logs.d("Opened connections: " + getClientsCount());
        }
    }
    ...
    private void closeSocketInput(Socket socket) {
        try {
            ...
            // There is no way to determine that client closed connection http://stackoverflow.com/a/10241044/999458
            // So just to prevent log flooding don't log stacktrace
            Logs.d("Releasing input stream… Socket is closed by client.");
        } catch (IOException e) {
    ...
    private void closeSocketOutput(Socket socket) {
        try {
            ...
            Logs.w("Failed to close socket on proxy side: {}. It seems client have already closed connection.", e.getMessage());
        }
    }
    ...
    private void onError(Throwable e) {
        Logs.e("HttpProxyCacheServer error", e);
    }
