package com.chaoji.other.danikula.videocache.file;
        ...
        for (File file : files) {
            ...
            if (!accepted) {
                ...
                if (deleted) {
                    totalCount--;
                    totalSize -= fileSize;
                    Logs.i("Cache file " + file + " is deleted because it exceeds cache limit");
                } else {
                    Logs.e("Error deleting file " + file + " for trimming cache");
                }
            }
        }
    }
