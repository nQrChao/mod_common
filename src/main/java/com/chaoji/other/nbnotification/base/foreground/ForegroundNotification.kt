package com.chaoji.other.nbnotification.base.foreground
...
import com.chaoji.other.nbnotification.utils.action.ActionManager
import com.chaoji.other.nbnotification.utils.action.chained.SequenceActionBuild
import com.chaoji.other.nbnotification.utils.action.extend.createAction
import com.chaoji.other.nbnotification.utils.action.extend.stopAction
import com.chaoji.other.nbnotification.utils.easytimer.EasyTimer
import com.chaoji.other.nbnotification.utils.tween.Easing
...
open class ForegroundNotification : ForegroundNotificationInterface {
    ...
    override fun onCreate(context: Context) {
        ...
        mRootView = mLayoutInflater.inflate(
            R.layout.nb_notification_notification_container,
            null
        ) as ViewGroup
