package com.chaoji.im.ui.dialog

import android.app.Activity
import android.content.*
import android.os.*
import com.chaoji.base.base.manager.CommonActivityManager
...
abstract class PermissionCallback : OnPermissionCallback {
    ...
    protected fun showPermissionDialog(permissions: MutableList<String>) {
        val activity: Activity? = CommonActivityManager.getInstance().getTopActivity()
        if ((activity == null) || activity.isFinishing || activity.isDestroyed) {
            return
        }
//        DialogMessage.Builder(activity)
//            .setTitle(R.string.common_permission_alert)
//            .setMessage(getPermissionHint(activity, permissions))
//            .setConfirm(R.string.common_permission_goto)
//            .setCancel(null)
//            .setCancelable(false)
//            .setListener(object : DialogMessage.OnListener {
//
