...
import com.chaoji.im.utils.Common.hideKeyboard
import com.chaoji.other.xpopup.core.BottomPopupView

@SuppressLint("ViewConstructor")
class XPopupBottomPay(context: Context, private var cancel: (() -> Unit)?, private var sure: ((payInfo: PayInfo) -> Unit)?) :
    BottomPopupView(context), ClickAction, KeyboardAction {
    override fun getImplLayoutId(): Int = R.layout.pay_bottom_dialog
