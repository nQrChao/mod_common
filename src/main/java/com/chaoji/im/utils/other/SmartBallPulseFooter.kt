...
class SmartBallPulseFooter @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
    ...
    init {
        minimumHeight = resources.getDimension(R.dimen.idp_60).toInt()
        paint.color = Color.WHITE
        paint.style = Paint.Style.FILL
        paint.isAntiAlias = true
        mSpinnerStyle = SpinnerStyle.Translate
        circleSpacing = resources.getDimension(R.dimen.idp_2)
        paint.textSize = resources.getDimension(R.dimen.isp_14)
