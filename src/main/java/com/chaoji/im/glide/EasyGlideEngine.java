...
public class EasyGlideEngine implements ImageEngine {
    ...
    private static final class InstanceHolder {
        //单例
        static final EasyGlideEngine instance = new EasyGlideEngine();
    }

    //获取单例
    public static EasyGlideEngine getInstance() {
    ...
    public void loadPhoto(@NonNull Context context, @NonNull Uri uri, @NonNull ImageView imageView) {
        GlideApp.with(context).load(uri).transition(withCrossFade()).into(imageView);
    }
    ...
    public void loadGifAsBitmap(@NonNull Context context, @NonNull Uri gifUri, @NonNull ImageView imageView) {
        GlideApp.with(context).asBitmap().load(gifUri).into(imageView);
    }
    ...
    public void loadGif(@NonNull Context context, @NonNull Uri gifUri, @NonNull ImageView imageView) {
        GlideApp.with(context).asGif().load(gifUri).transition(withCrossFade()).into(imageView);
    }
