...
import com.chaoji.base.network.LogInterceptor.Companion.isJson
import com.chaoji.base.network.LogInterceptor.Companion.isXml
import com.chaoji.base.utils.CharacterHandler.Companion.jsonFormat
import com.chaoji.base.utils.CharacterHandler.Companion.xmlFormat
...
class DefaultFormatPrinter : FormatPrinter {
    ...
    override fun printJsonRequest(
        ...
        val tag = getTag(true)
        ImLog.debugInfo(tag, REQUEST_UP_LINE)
        logLines(
            tag,
    ...
    override fun printJsonResponse(
        ...
        ImLog.debugInfo(tag, RESPONSE_UP_LINE)
