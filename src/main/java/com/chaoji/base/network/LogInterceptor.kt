...
import com.chaoji.base.utils.UrlEncoderUtils.Companion.hasUrlEncoded
import com.chaoji.base.utils.ZipHelper.Companion.decompressForGzip
import com.chaoji.base.utils.ZipHelper.Companion.decompressToStringForZlib
...
class LogInterceptor : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if (logResponse) {
            ...
            val header: String = originalResponse.headers.toString()
