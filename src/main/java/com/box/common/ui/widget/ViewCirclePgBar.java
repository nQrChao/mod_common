...
public class ViewCirclePgBar extends View {
    ...
    public ViewCirclePgBar(Context context) {
        super(context);
        init();
    }

    public ViewCirclePgBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        getAttrs(context, attrs);
        init();
    }

    public ViewCirclePgBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void getAttrs(Context context, AttributeSet attrs) {
        ...
        mStrokeWidth =
            typedArray.getDimension(R.styleable.CodeEditText_strokeWidth, 5);
        typedArray.recycle();
    }
