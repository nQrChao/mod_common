...
public class ViewWaveSideBar extends View {
    ...
    public ViewWaveSideBar(Context context) {
        this(context, null);
    }

    public ViewWaveSideBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ViewWaveSideBar(Context context, AttributeSet attrs, int defStyleAttr) {
