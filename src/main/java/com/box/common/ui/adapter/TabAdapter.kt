...
class TabAdapter @JvmOverloads constructor(
    ...
    inner class SlidingViewHolder : AppViewHolder(R.layout.tab_item_sliding), AnimatorUpdateListener {
        ...
        private val mDefaultTextSize: Int by lazy { getResources().getDimension(R.dimen.isp_14).toInt() }
        private val mSelectedTextSize: Int by lazy { getResources().getDimension(R.dimen.isp_15).toInt() }
