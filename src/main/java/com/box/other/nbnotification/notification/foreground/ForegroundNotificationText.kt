package com.box.other.nbnotification.notification.foreground

import com.box.other.blankj.utilcode.util.ActivityUtils
import com.box.other.nbnotification.NBNotification
import com.box.other.nbnotification.utils.convertmainthread.ConvertMainThread
import com.box.other.nbnotification.utils.event.EventEmitter
import java.util.*
...
object ForegroundNotificationText {
    ...
    init {
        eventEmitter.on(EVENT_DESTROY_NAME) {
            ...
            if (nbBuilder != null) {
                val cnG = ActivityUtils.getTopActivity().localClassName + gInt
    ...
    fun notify(nbBuilder: NBNotification.Builder) {
        ConvertMainThread.runOnUiThread {
            ...
            val cnG = ActivityUtils.getTopActivity().localClassName + groupId
