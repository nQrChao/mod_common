package com.box.other.scwang.smartrefresh.layout.header;
...
import com.box.other.scwang.smartrefresh.layout.api.OnTwoLevelListener;
...
public class TwoLevelHeader extends com.box.other.scwang.smart.refresh.header.TwoLevelHeader implements RefreshHeader {
    ...
    public TwoLevelHeader setOnTwoLevelListener(final OnTwoLevelListener listener) {
        super.setOnTwoLevelListener(new com.box.other.scwang.smart.refresh.header.listener.OnTwoLevelListener() {
            @Override
            public boolean onTwoLevel(@NonNull com.box.other.scwang.smart.refresh.layout.api.RefreshLayout refreshLayout) {
    ...
    @Override
    public TwoLevelHeader setRefreshHeader(com.box.other.scwang.smart.refresh.layout.api.RefreshHeader header) {
        super.setRefreshHeader(header);
        return this;
    }

    @Override
    public TwoLevelHeader setRefreshHeader(com.box.other.scwang.smart.refresh.layout.api.RefreshHeader header, int width, int height) {
