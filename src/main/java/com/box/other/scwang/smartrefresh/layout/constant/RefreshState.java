package com.box.other.scwang.smartrefresh.layout.constant;
...
public enum RefreshState {
    ...
    public static RefreshState from(com.box.other.scwang.smart.refresh.layout.constant.RefreshState newState) {
