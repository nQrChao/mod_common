...
import com.box.other.xpopup.util.PermissionConstants;
import com.box.other.xpopup.util.XPermission;
import com.box.other.xpopup.util.XPopupUtils;
import com.box.other.xpopup.widget.BlankView;
import com.box.other.xpopup.widget.HackyViewPager;
import com.box.other.xpopup.widget.PhotoViewContainer;
