...
public class ShapeState extends Drawable.ConstantState {
    ...
    public ShapeState(ShapeState state) {
        ...
        shadowSizeAll = state.shadowSizeAll;
        shadowSizeLeft = state.shadowSizeLeft;
        shadowSizeRight = state.shadowSizeRight;
        shadowSizeTop = state.shadowSizeTop;
        shadowSizeBottom = state.shadowSizeBottom;
