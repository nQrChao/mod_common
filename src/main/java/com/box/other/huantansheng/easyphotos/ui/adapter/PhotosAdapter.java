...
import com.box.other.huantansheng.easyphotos.ui.widget.PressedImageView;
...
public class PhotosAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
            case TYPE_AD:
                return new AdViewHolder(mInflater.inflate(R.layout._easy_photos_item_ad, parent, false));
            case TYPE_CAMERA:
                return new CameraViewHolder(mInflater.inflate(R.layout._easy_photos_item_camera, parent, false));
            default:
                return new PhotoViewHolder(mInflater.inflate(R.layout._easy_photos_item_rv_photos, parent, false));
        }
    }
            ...
            ((PhotoViewHolder) holder).vSelector.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (item.selected) {
                        ...
                        ((PhotoViewHolder) holder).tvSelector.setBackgroundResource(R.drawable.easy_photos_bg_select_true);
    ...
    private void updateSelector(TextView tvSelector, boolean selected, Photo photo, int position) {
        if (selected) {
            ...
            if (number.equals("0")) {
                tvSelector.setBackgroundResource(R.drawable.easy_photos_bg_select_false);
                tvSelector.setText(null);
                return;
            }
            tvSelector.setText(number);
            tvSelector.setBackgroundResource(R.drawable.easy_photos_bg_select_true);
            if (isSingle) {
            ...
            if (unable) {
                tvSelector.setBackgroundResource(R.drawable.easy_photos_bg_select_false_unable);
            } else {
                tvSelector.setBackgroundResource(R.drawable.easy_photos_bg_select_false);
            }
            tvSelector.setText(null);
