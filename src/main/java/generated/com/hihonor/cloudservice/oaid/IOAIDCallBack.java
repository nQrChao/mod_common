...
public interface IOAIDCallBack extends android.os.IInterface
{
  ...
  abstract class Stub extends android.os.Binder implements IOAIDCallBack
  {
  ...
  String DESCRIPTOR = "com.hihonor.cloudservice.oaid.IOAIDCallBack";
  void a(int i, long j, boolean z, float f, double d, String str) throws android.os.RemoteException;
